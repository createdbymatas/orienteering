...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('70') == true || document.getElementById("answer").value.includes('eptyniasdešim') == true || document.getElementById("answer").value.includes('eptyniasdesim') == true || document.getElementById("answer").value.includes('eptynias dešim') == true || document.getElementById("answer").value.includes('eptynias desim') == true || document.getElementById("answer").value.includes('eptynesdešim') == true || document.getElementById("answer").value.includes('eptynesdesim') == true || document.getElementById("answer").value.includes('eptynes dešim') == true || document.getElementById("answer").value.includes('eptynes desim') == true){
