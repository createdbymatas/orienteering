...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('60') == true || document.getElementById("answer").value.includes('ešiasdešim') == true || document.getElementById("answer").value.includes('esiasdesim') == true || document.getElementById("answer").value.includes('esiasdešim') == true || document.getElementById("answer").value.includes('ešiasdesim') == true){
