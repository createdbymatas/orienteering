...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('3') == true || document.getElementById("answer").value.includes('ris') == true || document.getElementById("answer").value.includes('rys') == true){
