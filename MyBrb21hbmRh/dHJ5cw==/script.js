...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('rosnis') == true || document.getElementById("answer").value.includes('idinys') == true || document.getElementById("answer").value.includes('ecius') == true || document.getElementById("answer").value.includes('ečius') == true){
