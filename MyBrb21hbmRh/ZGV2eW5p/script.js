...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('tsarginis') == true || document.getElementById("answer").value.includes('apildomas') == true || document.getElementById("answer").value.includes('tliekamas') == true || document.getElementById("answer").value.includes('ezervinis') == true || document.getElementById("answer").value.includes('agalbinis') == true){
