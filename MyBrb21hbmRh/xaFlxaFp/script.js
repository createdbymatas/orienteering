...
function checkAnswer(){
    if(document.getElementById("answer").value == "5" || document.getElementById("answer").value == "5 vaikai" || document.getElementById("answer").value == "penki" || document.getElementById("answer").value == "Penki" || document.getElementById("answer").value == "penki vaikai" || document.getElementById("answer").value == "Penki vaikai"){
