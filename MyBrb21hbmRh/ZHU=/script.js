...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('amokas') == true || document.getElementById("answer").value.includes('amoka') == true || document.getElementById("answer").value.includes('amoką') == true || document.getElementById("answer").value.includes('amokos') == true || document.getElementById("answer").value.includes('amų darbus') == true || document.getElementById("answer").value.includes('amu darbus') == true || document.getElementById("answer").value.includes('amu darbai') == true || document.getElementById("answer").value.includes('amų darbai') == true){
