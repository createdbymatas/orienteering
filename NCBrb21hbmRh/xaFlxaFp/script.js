...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('28') == true || document.getElementById("answer").value.includes('videsim') == true && document.getElementById("answer").value.includes('stuoni') == true || document.getElementById("answer").value.includes('videšim') == true && document.getElementById("answer").value.includes('štuoni') == true || document.getElementById("answer").value.includes('videsim') == true && document.getElementById("answer").value.includes('štuoni') == true || document.getElementById("answer").value.includes('videšim') == true && document.getElementById("answer").value.includes('stuoni') == true){
