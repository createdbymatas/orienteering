...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('ismas') == true && document.getElementById("answer").value.includes('ratu') == true || document.getElementById("answer").value.includes('iedin') == true && document.getElementById("answer").value.includes('sankry') == true || document.getElementById("answer").value.includes('iedin') == true && document.getElementById("answer").value.includes('sąnkry') == true || document.getElementById("answer").value.includes('iedas') == true){
