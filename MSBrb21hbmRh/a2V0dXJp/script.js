...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('13') == true || document.getElementById("answer").value.includes('trylika') == true || document.getElementById("answer").value.includes('Trylika') == true){
