...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('utomagistral') == true || document.getElementById("answer").value.includes('uto magistral') == true || document.getElementById("answer").value.includes('utostrada') == true || document.getElementById("answer").value.includes('uto strada') == true || document.getElementById("answer").value.includes('reitkelis') == true || document.getElementById("answer").value.includes('reit kelis') == true){
