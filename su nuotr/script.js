...
function checkAnswer(){
    if(document.getElementById("answer").value == 'automagistralė' || document.getElementById("answer").value == 'Automagistralė' || document.getElementById("answer").value == 'automagistrale' || document.getElementById("answer").value == 'Automagistrale' || document.getElementById("answer").value == 'auto magistralė' || document.getElementById("answer").value == 'Auto magistralė' || document.getElementById("answer").value == 'auto magistrale' || document.getElementById("answer").value == 'Auto magistrale' || document.getElementById("answer").value == 'autostrada' || document.getElementById("answer").value == 'Autostrada' || document.getElementById("answer").value == 'auto strada' || document.getElementById("answer").value == 'Auto strada' || document.getElementById("answer").value == 'greitkelis' || document.getElementById("answer").value == 'Greitkelis' || document.getElementById("answer").value == 'greit kelis' || document.getElementById("answer").value == 'Greit kelis'){
