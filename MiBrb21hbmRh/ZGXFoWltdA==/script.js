...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('ešėlis') == true || document.getElementById("answer").value.includes('eselis') == true || document.getElementById("answer").value.includes('esėlis') == true || document.getElementById("answer").value.includes('ešelis') == true){
