...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('39') == true || document.getElementById("answer").value.includes('risdesim') == true && document.getElementById("answer").value.includes('devyni') == true || document.getElementById("answer").value.includes('risdešim') == true && document.getElementById("answer").value.includes('devyni') == true){
...
function readTask(){
    ...
    document.getElementById("daina").volume = 0.3;
}
...
function playSong(){
    if(document.getElementById("playBtnIcon").classList.contains("fa-pause")){
        document.getElementById("daina").pause();
        document.getElementById("playBtnText").innerHTML = "Leisti";
        document.getElementById("playBtnIcon").classList.remove("fa-pause");
        document.getElementById("playBtnIcon").classList.add("fa-play");
        ...
        document.getElementById("daina").play();
        document.getElementById("playBtnText").innerHTML = "Pristabdyti";
        document.getElementById("playBtnIcon").classList.add("fa-pause");
        document.getElementById("playBtnIcon").classList.remove("fa-play");
        document.getElementById("soundtrack").style.width = "245px";
         document.getElementById("soundtrack").style.marginLeft = "-122.5px";
    }
}
document.getElementById("daina").addEventListener("timeupdate", (e)=>{
...
document.getElementById("daina").onended = function() {
    document.getElementById("daina").pause();
        document.getElementById("playBtnText").innerHTML = "Leisti";
        document.getElementById("playBtnIcon").classList.remove("fa-pause");
        document.getElementById("playBtnIcon").classList.add("fa-play");
