...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('2') == true || document.getElementById("answer").value.includes('du') == true || document.getElementById("answer").value.includes('Du') == true){
