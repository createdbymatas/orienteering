...
function checkAnswer(){
    if(document.getElementById("answer").value.includes('tovėjimo vieta') == true || document.getElementById("answer").value.includes('tovejimo vieta') == true || document.getElementById("answer").value.includes('tovejimas') == true || document.getElementById("answer").value.includes('toveti') == true || document.getElementById("answer").value.includes('arkingas') == true || document.getElementById("answer").value.includes('arkavimas') == true || document.getElementById("answer").value.includes('arkuoti') == true || document.getElementById("answer").value.includes('arkingo vieta') == true || document.getElementById("answer").value.includes('arkavimo vieta') == true){
